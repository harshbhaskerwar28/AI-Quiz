      ...
      <CardContent>
        ...
        >
          <Input
            ...
            className={`${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white/20 border-white/30 text-white placeholder-white/50'} text-lg py-6 text-center`}
          />
        </motion.form>
      </CardContent>
      <CardFooter>
        ...
        >
          <Button
            ...
            disabled={!name.trim()}
            className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xl py-6 rounded-full font-bold"
          >
            Dive In! 🏄‍♂️
          </Button>
        </motion.div>
